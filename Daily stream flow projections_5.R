...
gw<- 0.009  #set to zero if no ground water contribution expected
...
bias <- 0.35785 #set to 1 if no bias adjustment needed
...
parms <- as.numeric(c(0.99999, 0.3, 0.54))#obtain these parameter values from 
...
q3 <- 0.408             # initial condition for quick flow
s3 <- 0.051   #0.024          # initial condition for slow flow
