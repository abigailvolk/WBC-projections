...
```{r istat-summary, echo=FALSE}
istat_results %>% 
  ggplot(aes(x=`Discharge Statistic Name`, y=slope)) +
  geom_col() +
  coord_flip() +
  labs(x="Discharge statistic", y="Slope (cfs/year)") +
  nps_theme2() +
  scale_y_continuous(breaks = seq(-0.02, 0, by = 0.005))
```
...
#Peak Flow
write.csv(peakFlow, file = paste0(futures_folder, "/", site, "PeakFlow.csv"))
# Stat results
